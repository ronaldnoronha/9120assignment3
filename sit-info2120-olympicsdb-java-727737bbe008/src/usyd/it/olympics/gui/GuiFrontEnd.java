...
public final class GuiFrontEnd {
	...
	private final MedalTallyScreen medalTallyScreen;
	...
	private final String optMedalTally = "Medal Tally";
	...
	public GuiFrontEnd(OlympicsDBClient root) {
		...
		// If member is not staff deactive make booking BUT HOW????
		...
		// Medal Tally extension
		addMenuOption(optMedalTally, new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				client.medalTally();
			}
		...
		registerScreen(medalTallyScreen = new MedalTallyScreen(root), "medalTallyScreen");
	...
	public MedalTallyScreen getMedalTallyScreen() {
		return medalTallyScreen;
	}
