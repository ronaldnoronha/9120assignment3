...
public class MedalTallyScreen extends GuiScreen {
    ...
    public MedalTallyScreen(OlympicsDBClient r) {
        super(r);
    ...
    public void showMedalTally(ArrayList<HashMap<String, Object>> bookings) {
